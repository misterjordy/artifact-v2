...
def upgrade() -> None:
    op.create_table(
        "fc_user",
        sa.Column("user_uid", postgresql.UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"), nullable=False),
    ...
    op.create_table(
        "fc_node",
        sa.Column("node_uid", postgresql.UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"), nullable=False),
    ...
    op.create_table(
        "fc_node_permission",
        sa.Column("permission_uid", postgresql.UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"), nullable=False),
    ...
    op.create_index("idx_perm_user", "fc_node_permission", ["user_uid"], postgresql_where=sa.text("revoked_at IS NULL"))
    op.create_index("idx_perm_node", "fc_node_permission", ["node_uid"], postgresql_where=sa.text("revoked_at IS NULL"))
    ...
    op.create_table(
        "fc_api_key",
        sa.Column("key_uid", postgresql.UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"), nullable=False),
        sa.Column("user_uid", postgresql.UUID(as_uuid=True), nullable=False),
